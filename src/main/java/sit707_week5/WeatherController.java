...
public class WeatherController {
	 ...
	 * @return
	 */
	public static WeatherController getInstance(final CustomDate customDate) {
		if (instance == null) {
			instance = new WeatherController(customDate);
		}
		return instance;
	}
	 ...
	 */
	private WeatherController(final CustomDate customDate) {
	...
	public String persistTemperature(int hour, double temperature) {
		...
		String savedTime = sdf.format(customDate.getDate());
